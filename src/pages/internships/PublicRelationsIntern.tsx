...
export default function PrCommunicationsInternshipPage() {

  // --- Pre-written Mailto Link for this specific role ---
  const email = 'careers@ayurgenx.in';
  const subject = encodeURIComponent("Internship Application: PR, Communications & Public Image");
  const body = encodeURIComponent(
`Dear AyurGenX Hiring Team,

I am writing to express my strong interest in the PR, Communications & Public Image Intern position.

- Name: [Your Name]
- Contact: [Your Phone Number and LinkedIn Profile URL]
- Education: [e.g., BA in Communications/Journalism]

I am passionate about building trust and clarity for mission-driven brands. My resume and any relevant writing samples are attached.
      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-brand-gray">
            PR, Communications & Public Image Intern
          </h1>
          <p className="mt-4 text-lg text-slate-600">
            (Brand Narrative • Media Communication • Founder & Company Image)
          </p>
        </div>
      </motion.header>
          ...
          <div className="lg:col-span-2">
            ...
            >
              <Section title="🌍 About AyurGenX">
                <p><strong className="text-vitality-teal">AyurGenX</strong> is a deep-tech preventive healthcare company building the world’s first AI-powered Reverse Aging & Organ Health Intelligence Platform, rooted in Ayurveda, Naturopathy, and modern AI systems.</p>
                <p>We operate within an <strong className="text-vitality-teal">IIT Madras</strong>–backed innovation ecosystem, with strategic guidance and execution discipline inspired by <strong className="text-vitality-teal">IIM</strong> frameworks.</p>
              </Section>
              
              <Section title="🎯 Internship Overview">
                <p>As a PR, Communications & Public Image Intern, you will work on how <strong className="text-vitality-teal">AyurGenX</strong> is perceived by the world — across media, digital platforms, and founder communication. This role is not marketing or sales; your responsibility is to build clarity, credibility, and trust around our scientific mission and long-term vision.</p>
              </Section>

              <Section title="📰 Key Responsibilities">
                <ul className="space-y-3">
                  <ListItem>Draft and refine press notes, public announcements, and media communications.</ListItem>
                  <ListItem>Shape a consistent narrative around preventive healthcare and AI + Ayurveda integration.</ListItem>
                  <ListItem>Assist in founder/leadership communication, including LinkedIn posts and public statements.</ListItem>
                  <ListItem>Convert complex research into understandable public narratives.</ListItem>
                </ul>
              </Section>
              
              <Section title="🎓 Who Should Apply">
                  <p>Students or fresh graduates from Media & Communication, Journalism, English, Humanities, or Management. Ideal for individuals interested in responsible science communication and building trust for a HealthTech brand.</p>
              </Section>

              <Section title="🚀 What You Will Gain">
                <ul className="space-y-3">
                  <ListItem>Experience shaping the public voice of a HealthTech platform from an early stage.</ListItem>
                  <ListItem>Exposure to founder-level communication strategy and trust-based brand building.</ListItem>
                  <ListItem>Mentorship within an <strong className="text-vitality-teal">IIT Madras</strong>–backed innovation ecosystem, aligned with <strong className="text-vitality-teal">IIM</strong>-style strategic thinking.</ListItem>
                </ul>
              </Section>
            ...
            >
              ...
              <div className="mt-8 bg-white rounded-2xl shadow-xl border border-light-gray p-6">
                ...
                <ul className="space-y-5 mb-8">
                  <InfoItem icon={Briefcase} label="Position" value="PR & Communications Intern" />
