...
export default function YogaInternshipPage() {

  // --- Pre-written Mailto Link for this specific role ---
  const email = 'careers@ayurgenx.in';
  const subject = encodeURIComponent("Internship Application: Yoga & Mind–Body Wellness");
  const body = encodeURIComponent(
`Dear AyurGenX Hiring Team,

I am writing to express my strong interest in the Yoga & Mind–Body Wellness Intern position.

- Name: [Your Name]
- Contact: [Your Phone Number and LinkedIn Profile URL]
- Education/Certification: [e.g., Certified Yoga Instructor, YTTC 200/500]

I am passionate about the therapeutic application of yoga and believe my skills would be a valuable asset to your team. My resume is attached for your review.
      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-brand-gray">
            AyurGenX Yoga & Mind–Body Wellness Intern
          </h1>
        </div>
      </motion.header>
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <Section title="🌍 About AyurGenX">
                <p><strong className="text-vitality-teal">AyurGenX</strong> is a deep-tech preventive healthcare platform building the world’s first AI-driven Reverse Aging & Organ Health Ecosystem, integrating Yoga, Ayurveda, Naturopathy, lifestyle medicine, and technology.</p>
              ...
              <Section title="🎯 Internship Overview">
                <p>As a Yoga & Mind–Body Wellness Intern, you will work closely under experienced yoga and medical mentors and within the <strong className="text-vitality-teal">IIT Madras</strong>–supported <strong className="text-vitality-teal">AyurGenX</strong> ecosystem, with guidance aligned to <strong className="text-vitality-teal">IIT</strong>-level research rigor and <strong className="text-vitality-teal">IIM</strong>-style systems thinking.</p>
                <p>This internship focuses on therapeutic, preventive, and lifestyle-integrated yoga, not generic fitness sessions. Interns contribute to building structured yoga-based interventions that support organ health, stress regulation, and long-term wellbeing.</p>
              </Section>

              {/* Key Responsibilities */}
              <Section title="🧩 Key Responsibilities">
                <ul className="space-y-3">
                  <ListItem>Assist in developing yoga-based preventive and therapeutic routines.</ListItem>
                  <ListItem>Contribute to protocols focused on stress regulation, mobility, breathwork (Pranayama), and sleep.</ListItem>
                  <ListItem>Support mentors in converting yogic principles into structured, repeatable programs.</ListItem>
                  <ListItem>Collaborate with Ayurveda, Naturopathy, Nutrition, and Product teams.</ListItem>
                  <ListItem>Assist in the documentation and validation of yoga protocols for platform integration.</ListItem>
                </ul>
              </Section>
              
              {/* Who Should Apply */}
              <Section title="🎓 Who Should Apply">
                  <p>Certified Yoga instructors or students from Yoga Therapy programs (PG Diploma / Bachelor / Master in Yoga). This role is for individuals interested in preventive yoga, mind-body medicine, and digital health, who are comfortable in a research-driven, structured environment.</p>
              </Section>

              {/* What You Will Gain */}
               <Section title="🧠 What You Will Gain">
                <ul className="space-y-3">
                  <ListItem>Exposure to modern, evidence-informed applications of yoga.</ListItem>
                  <ListItem>Experience building yoga-based preventive systems at scale.</ListItem>
                  ...
                  <ListItem>Understanding of how yoga integrates with medical logic and technology platforms.</ListItem>
                  <ListItem>A strong foundation for careers in preventive healthcare, yoga therapy, and HealthTech.</ListItem>
                </ul>
              </Section>
            ...
            >
              ...
              <div className="mt-8 bg-white rounded-2xl shadow-xl border border-light-gray p-6">
                ...
                <ul className="space-y-5 mb-8">
                  <InfoItem icon={Briefcase} label="Position" value="Yoga & Mind–Body Intern" />
