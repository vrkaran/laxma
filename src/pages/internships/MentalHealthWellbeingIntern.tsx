...
export default function MentalHealthInternshipPage() {

  // --- Pre-written Mailto Link for this specific role ---
  const email = 'careers@ayurgenx.in';
  const subject = encodeURIComponent("Internship Application: Mental Health & Emotional Wellbeing");
  const body = encodeURIComponent(
`Dear AyurGenX Hiring Team,

I am writing to express my strong interest in the Mental Health & Emotional Wellbeing Intern position.

- Name: [Your Name]
- Contact: [Your Phone Number and LinkedIn Profile URL]
- Education: [e.g., MA/MSc Psychology]

I am passionate about preventive mental health and believe my skills would be a valuable asset to your team. My resume is attached for your review.
      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-brand-gray">
            AyurGenX Mental Health & Emotional Wellbeing Intern
          </h1>
        </div>
      </motion.header>
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <Section title="🌍 About AyurGenX">
                <p><strong className="text-vitality-teal">AyurGenX</strong> is a deep-tech preventive healthcare platform building the world’s first AI-driven Reverse Aging & Organ Health Ecosystem, integrating mental health, lifestyle medicine, Ayurveda, and technology.</p>
                <p>Built within an <strong className="text-vitality-teal">IIT Madras</strong>–backed innovation ecosystem, <strong className="text-vitality-teal">AyurGenX</strong> applies research-driven thinking and <strong className="text-vitality-teal">IIM</strong>-aligned execution frameworks to design scalable and ethically grounded mental wellbeing systems.</p>
              </Section>
              
              {/* Internship Overview */}
              <Section title="🎯 Internship Overview">
                <p>As a Mental Health & Emotional Wellbeing Intern, you will work closely under experienced mentors within the <strong className="text-vitality-teal">IIT Madras</strong>–supported <strong className="text-vitality-teal">AyurGenX</strong> ecosystem, with guidance aligned to <strong className="text-vitality-teal">IIT</strong>-level research rigor and <strong className="text-vitality-teal">IIM</strong>-style systems thinking.</p>
                <p>This internship focuses on preventive mental health and habit-based wellbeing, not clinical therapy. Interns contribute to building structured mental wellbeing frameworks that integrate with physical health and technology platforms.</p>
              </Section>

              {/* Key Responsibilities */}
              <Section title="🧩 Key Responsibilities">
                <ul className="space-y-3">
                  <ListItem>Assist in developing preventive mental health and emotional wellbeing frameworks.</ListItem>
                  <ListItem>Contribute to areas like stress regulation, emotional resilience, and sleep/burnout management.</ListItem>
                  <ListItem>Support mentors in translating psychological principles into structured, user-friendly guidance.</ListItem>
                  <ListItem>Collaborate with Ayurveda, Nutrition, Yoga, and Product teams.</ListItem>
              ...
              <Section title="🎓 Who Should Apply">
                  <p>Students or graduates from Psychology, Mental Health, or Behavioural Science. Ideal for individuals interested in preventive mental health, digital health platforms, and working in a research-driven, structured innovation environment.</p>
              </Section>

              {/* What You Will Gain */}
               <Section title="🧠 What You Will Gain">
                <ul className="space-y-3">
                  <ListItem>Exposure to modern preventive mental health applications.</ListItem>
                  <ListItem>Experience building mental wellbeing systems at scale.</ListItem>
                  ...
                  <ListItem>Understanding of how mental health integrates with lifestyle and technology.</ListItem>
                </ul>
              </Section>
            ...
            >
              ...
              <div className="mt-8 bg-white rounded-2xl shadow-xl border border-light-gray p-6">
                ...
                <ul className="space-y-5 mb-8">
                  <InfoItem icon={Briefcase} label="Position" value="Mental Health & Wellbeing Intern" />
