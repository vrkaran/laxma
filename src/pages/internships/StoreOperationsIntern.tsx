...
export default function StoreOperationsInternPage() {

  // --- Pre-written Mailto Link for this specific role ---
  const email = 'careers@ayurgenx.in';
  const subject = encodeURIComponent("Internship Application: Store Operations Intern");
  const body = encodeURIComponent(
`Dear AyurGenX Hiring Team,

I am writing to express my strong interest in the Store Operations Intern position.

- Name: [Your Name]
- Contact: [Your Phone Number and LinkedIn Profile URL]
- Education: [e.g., B.Com/BBA Student, Year]

I am interested in e-commerce operations and believe my organizational skills would be a valuable asset. My resume is attached.
      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="mt-4 text-lg text-slate-700">
            (E-commerce • Inventory • Customer Support)
          </p>
        </div>
      </motion.header>
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <Section title="🌍 About the Opportunity">
                <p>AyurGenX's online store is the bridge between our health recommendations and the therapeutic products that users need. We are looking for a Store Operations Intern to help ensure smooth daily operations, from order processing to customer satisfaction.</p>
                <p>This role offers hands-on experience in e-commerce operations within a fast-growing HealthTech company. You will work closely with the product and logistics teams to maintain high service standards.</p>
              </Section>
              
              {/* Key Responsibilities */}
              <Section title="📦 Key Responsibilities">
                <h3 className="text-lg font-semibold text-brand-gray mb-2">🛒 Order & Inventory Management</h3>
                <ul className="space-y-2 mb-4">
                  <ListItem>Assist in processing daily orders and ensuring timely dispatch.</ListItem>
                  <ListItem>Monitor inventory levels and coordinate stock replenishment.</ListItem>
                  <ListItem>Track shipment status and resolve delivery issues.</ListItem>
                </ul>
                <h3 className="text-lg font-semibold text-brand-gray mb-2">💬 Customer Support</h3>
                <ul className="space-y-2 mb-4">
                  <ListItem>Handle customer inquiries regarding products, orders, and returns.</ListItem>
                  <ListItem>Provide friendly and helpful support via email or chat.</ListItem>
                </ul>
                <h3 className="text-lg font-semibold text-brand-gray mb-2">📊 Platform & Performance</h3>
                <ul className="space-y-2 mb-4">
                  <ListItem>Assist in updating product listings and descriptions on the store.</ListItem>
                  <ListItem>Monitor website performance and report any issues.</ListItem>
                  <ListItem>Support marketing campaigns and promotions.</ListItem>
                </ul>
              </Section>
              
              {/* Who This Role Is For */}
              <Section title="🎓 Who This Role Is Suited For">
                  <p>Students or recent graduates with an interest in e-commerce, operations, supply chain, or business administration. We value organized, reliable individuals who are customer-focused.</p>
              </Section>

              {/* What This Role Is NOT */}
              <Section title="🚫 What This Role Does Not Involve">
                  <p>This role does not involve product formulation, medical advice, or software development. It is focused on the operational side of the e-commerce store.</p>
              </Section>
            ...
            >
              ...
              <div className="mt-8 bg-white rounded-2xl shadow-xl border border-light-gray p-6">
                ...
                <ul className="space-y-5 mb-8">
                  <InfoItem icon={Briefcase} label="Position" value="Store Operations Intern" />
